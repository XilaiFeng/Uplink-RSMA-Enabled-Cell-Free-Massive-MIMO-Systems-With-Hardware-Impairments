...
def exponential_decay(optimizer, initial_lr, global_step, decay_steps, decay_rate):
...
def natural_exp_decay(optimizer, initial_lr, global_step, decay_steps, decay_rate):
